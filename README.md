...
1. Identificação Nome do aluno: Maísa Costa Borges

2. Docker no Codespaces Versão do Docker utilizada: Docker version 29.3.0-1
...
3. Qual é a função do Dockerfile neste exercício?
 arquivo define uma imagem baseada no Ubuntu, cria o diretório de trabalho /app, copia o arquivo hello.txt para a imagem e define o comando que será executado quando o contêiner iniciar.
